...
const roleLabel: Record<DashboardIdentity["role"], string> = {
  ...
  useEffect(() => {
    ...
    const connectSharedRegister = async () => {
      ...
      setSharedExceptionSync((current) => ({
        ...current,
        phase: "connecting",
        message: "Connexion à l’espace chiffré de votre organisation…",
      }));
      try {
        ...
        setSharedExceptionSync({
          ...
          message: body.sync?.capabilities?.canSync
            ? "Session MCP TrustMap vérifiée. Le registre local est à jour."
            : "Session MCP TrustMap vérifiée. Accès au registre en lecture seule.",
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-foot">
          ...
          <a className="profile-button" href="/settings">
      ...
      <main className="main">
        <header className="topbar">
          <div>
            <p className="eyebrow">
              {identity.organizationName.toUpperCase()} / PRODUCTION
            </p>
            <h1>
